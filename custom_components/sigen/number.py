...
PLANT_NUMBERS = [
    ...
    SigenergyNumberEntityDescription(
        ...
        native_step=0.001,
        entity_category=EntityCategory.CONFIG,
        value_fn=lambda data, _: data["plant"].get("plant_pcc_power_factor_grid_import", 0) / 1000,
    ...
    SigenergyNumberEntityDescription(
        ...
        native_step=0.001,
        entity_category=EntityCategory.CONFIG,
        value_fn=lambda data, _: data["plant"].get("plant_pcc_power_factor_grid_export", 0) / 1000,
